package org.projects.centralpoint.Database.Test;
...
public class PersistenceConfigTest {
    ...
    public void init()
    {
        appSettings.setDbResourcesPath(environment.getRequiredProperty("imageResourceTest"));
        createResourceDirStruct();
    }

    private void createResourceDirStruct()
    {
        String rootPath = environment.getRequiredProperty("imageResourceTest");
